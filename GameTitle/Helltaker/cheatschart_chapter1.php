    ...
    <div class="row">
      ...
      <ul>
        ...
        <div class="collapse show" id="collapse-answer">
          ...
          <img src="./images/Stage1_Map.JPG" class="img-fluid" alt="stage1_result.JPG" width="850" height="650">
        ...
        <div class="collapse show" id="collapse-choices">
          ...
          <img src="./images/stage1_result.JPG" class="img-fluid" alt="stage1_result.JPG" width="850" height="650">
          ...
          <table class="table-responsive">
            ...
            <tr>
              ...
              <td class="cell-info"><a href="" title="チャプター2 好色悪魔">チャプター2 好色悪魔</a>へ</td>
            </tr>
          </table>
        </div>

        <!-- 動画 -->
        <h4 class="content dropdown-bar" id="choices" data-toggle="gamevideo" data-target="#collapse-gamevideo" aria-controls="collapse-gamevideo">動画　▼</h4>
