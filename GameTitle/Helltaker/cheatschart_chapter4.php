...
<head>
  ...
  <title>チャプター4 毒舌悪魔 : Helltaker攻略</title>
</head>
<body>
    ...
    <div class="row">
      ...
      <ul>
        ...
        <div class="collapse show" id="collapse-answer">
          ...
          <ul>
            <li>スタート画面</li>
            <img src="./images/chapter4-map.jpg" class="img-fluid" alt="チャプター4マップ" width="850" height="650">
          </ul>
          ...
          <ul>
            ...
            <ol>
              ...
              <li>↑→↓（ブロックを蹴る）↓→↑（ブロックを蹴る）↑→（ブロックを蹴る）</li>
              <li>→↓（ブロックを蹴る）↓→（ブロックを蹴る）→（古代の碑文ゲット）</li>
              <li>↑（ブロックを蹴る）↑（ゴール）</li>
            </ol>
          </ul>
        ...
        <div class="collapse show" id="collapse-choices">
          ...
          <img src="./images/chapter4-choices.jpg" class="img-fluid" alt="チャプター4選択肢" width="850" height="650">
          <table class="table-responsive">
            <tr>
            ...
            <tr>
              <td class="cell-info">COOPキャンペーンの実績を取る相手を探している。</td>
              <td class="cell-info"><a href="./cheatschart_chapter5.php" title="チャプター5 性悪悪魔">チャプター5 性悪悪魔</a>へ</td>
            </tr>
            <tr>
              <td class="cell-info">たまらんな。もっと罵ってくれないか？</td>
        ...
        <div class="embed-responsive embed-responsive-16by9 collapse show" id="collapse-gamevideo">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/_uOYwECwZ90" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
      </div>
