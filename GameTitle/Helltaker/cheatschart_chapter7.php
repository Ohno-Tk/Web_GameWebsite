...
<head>
  ...
  <title>チャプター7 激ヤバ悪魔 : Helltaker攻略</title>
</head>
<body>
    ...
    <div class="row">
      ...
      <ul>
        ...
        <div class="collapse show" id="collapse-answer">
          ...
          <ul>
            <li>スタート画面</li>
            <img src="./images/chapter7-map.jpg" class="img-fluid" alt="チャプター7マップ" width="850" height="650">
          </ul>
          ...
          <ul>
            <li>手順</li>
            <ol>
              <li>↑↑（ブロックを蹴る）↓←←↑（敵を倒す）↑→（ブロックを蹴る）</li>
              <li>↓↓↓←←←↑↑↑（敵を蹴る）↑→（ブロックを蹴る）→↑（鍵ゲット）</li>
              <li>↓→（ブロックを蹴る）→→（ブロックを蹴る）→↑（ブロックを蹴る）</li>
              <li>↑→（ブロックを蹴る）→↑（錠を開ける）↑（ゴール）</li>
            </ol>
          </ul>
        </div>
        ...
        <div class="embed-responsive embed-responsive-16by9 collapse show" id="collapse-gamevideo">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Tey0WQUrBcw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
      </div>
